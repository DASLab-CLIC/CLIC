...
public class Job implements org.apache.thrift.TBase<Job, Job._Fields>, java.io.Serializable, Cloneable, Comparable<Job> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.subplans = new java.util.HashMap<java.lang.Integer,Stage>(2*_map122.size);
                int _key123;
                @org.apache.thrift.annotation.Nullable Stage _val124;
                for (int _i125 = 0; _i125 < _map122.size; ++_i125)
                {
                  _key123 = iprot.readI32();
                  _val124 = new Stage();
                  _val124.read(iprot);
                  struct.subplans.put(_key123, _val124);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.sourceStages = new java.util.ArrayList<java.lang.Integer>(_list126.size);
                int _elem127;
                for (int _i128 = 0; _i128 < _list126.size; ++_i128)
                {
                  _elem127 = iprot.readI32();
                  struct.sourceStages.add(_elem127);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.others = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map129.size);
                @org.apache.thrift.annotation.Nullable java.lang.String _key130;
                @org.apache.thrift.annotation.Nullable java.lang.String _val131;
                for (int _i132 = 0; _i132 < _map129.size; ++_i132)
                {
                  _key130 = iprot.readString();
                  _val131 = iprot.readString();
                  struct.others.put(_key130, _val131);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Job struct) throws org.apache.thrift.TException {
      ...
      if (struct.subplans != null) {
        oprot.writeFieldBegin(SUBPLANS_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.Integer, Stage> _iter133 : struct.subplans.entrySet())
          {
      ...
      if (struct.sourceStages != null) {
        oprot.writeFieldBegin(SOURCE_STAGES_FIELD_DESC);
        {
          ...
          for (int _iter134 : struct.sourceStages)
          {
      ...
      if (struct.others != null) {
        oprot.writeFieldBegin(OTHERS_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter135 : struct.others.entrySet())
          {
  ...
  private static class JobTupleScheme extends org.apache.thrift.scheme.TupleScheme<Job> {
      ...
      if (struct.isSetSubplans()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.Integer, Stage> _iter136 : struct.subplans.entrySet())
          {
      ...
      if (struct.isSetSourceStages()) {
        {
          ...
          for (int _iter137 : struct.sourceStages)
          {
      ...
      if (struct.isSetOthers()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter138 : struct.others.entrySet())
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, Job struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(1)) {
        {
          org.apache.thrift.protocol.TMap _map139 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.I32, org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.subplans = new java.util.HashMap<java.lang.Integer,Stage>(2*_map139.size);
          int _key140;
          @org.apache.thrift.annotation.Nullable Stage _val141;
          for (int _i142 = 0; _i142 < _map139.size; ++_i142)
          {
            _key140 = iprot.readI32();
            _val141 = new Stage();
            _val141.read(iprot);
            struct.subplans.put(_key140, _val141);
          }
        }
        struct.setSubplansIsSet(true);
      }
      if (incoming.get(2)) {
        {
          ...
          struct.sourceStages = new java.util.ArrayList<java.lang.Integer>(_list143.size);
          int _elem144;
          for (int _i145 = 0; _i145 < _list143.size; ++_i145)
          {
            _elem144 = iprot.readI32();
            struct.sourceStages.add(_elem144);
          }
        }
        struct.setSourceStagesIsSet(true);
      }
      ...
      if (incoming.get(6)) {
        {
          ...
          struct.others = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map146.size);
          ...
          for (int _i149 = 0; _i149 < _map146.size; ++_i149)
          {
            ...
            struct.others.put(_key147, _val148);
          }
        }
        struct.setOthersIsSet(true);
      }
